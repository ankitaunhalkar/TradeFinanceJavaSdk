...
public interface ITradeService {
	ResponseContractDto createcontract(CreateContractDto contract, String token)
			throws EnrollmentException, InvalidArgumentException, Exception;

	ResponseContractDto updateContract(String contractId)
			throws EnrollmentException, InvalidArgumentException, Exception;

	boolean invokeChaincode(Contract contract, String function)
			throws EnrollmentException, InvalidArgumentException, Exception;
