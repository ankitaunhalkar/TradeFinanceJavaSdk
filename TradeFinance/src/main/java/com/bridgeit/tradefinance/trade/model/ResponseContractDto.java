...
public class ResponseContractDto {
	...
	public ResponseContractDto(Contract contract) {
		...
		this.contract_customstatus = contract.isContract_customstatus();
		this.contract_importerbankstatus = contract.isContract_importerbankstatus();
		this.contract_insurancestatus = contract.isContract_insurancestatus();
	}
